...
class Preprocess4Seq2seq(Pipeline):
    ...
    def __call__(self, instance):
        ...
        # input_ids 是经过mask处理后的token_id
        # segment_ids 是0, 1的segment_isd
        # input_mask 是UNILM的mask
        # mask_qkv 好像也是一个0,1 的类似于segment_ids, 不过seq_b后面的pads是用0表示
        # masked_ids 是盖住的id?
        # masked_pos
