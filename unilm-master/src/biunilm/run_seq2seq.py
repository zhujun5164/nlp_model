...
def main():
    ...
    parser.add_argument("--label_smoothing", default=0, type=float,
                        help="The initial learning rate for Adam.")
    # weight部分的学习率衰减(其实应该直有weight的权重进行衰减了,bias是不参与训练的)
    ...
    # 是否使用new segment ids来做UNILM 这个是微软自己定义的一套segment id,实际上应该是不用的
    ...
    # 是否使用seqment embedding上使用自注意力机制
    ...
    if args.do_train:
        ...
        bi_uni_pipeline = [seq2seq_loader.Preprocess4Seq2seq(args.max_pred,
                                                             args.mask_prob,
        ...
        train_dataset = seq2seq_loader.Seq2SeqDataset(fn_src,
                                                      fn_tgt,
    ...
    # 如果是用16为计算,同时调用apex库中的amp混合进度计算模块
    ...
    if (recover_step is None) and (args.model_recover_path is None):
        ...
        model = BertForPreTrainingLossMask.from_pretrained(args.bert_model,
